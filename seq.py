...
# Train the model
history = model.fit(train_sequences, train_labels, epochs=100, batch_size=32, validation_split=0.1, callbacks=[early_stopping])

# Access the loss values for each epoch
